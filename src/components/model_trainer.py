...
# Define a dataclass for storing model training configuration
@dataclass
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # Evaluate models using training and testing data
            ...
            # If the best model's R2 score is less than 0.6, raise an exception
            ...
            # Make predictions using the best model and calculate R2 score
